...
All data and code for the article, ["Weak magnetic field effects in biology are measurable—accelerated _Xenopus_ embryogenesis in the absence of the geomagnetic field"](https://bit.ly/Weak-magnetic-field-effects-in-biology-are-measurable). In the article, Supplementary Section SI69 is a guide to this GitHub repository. 
